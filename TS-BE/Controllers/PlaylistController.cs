...
namespace TS_BE.Controllers
{
    public class PlaylistController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Seed")] Playlist playlist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Seed")] Playlist playlist)
        {
            if (id != playlist.Id)
            {
                return NotFound();
